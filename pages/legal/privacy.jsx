  ...
  return (
    <div className="px-3">
      ...
      <p>
        ...
        Wir erheben und verarbeiten personenbezogene Daten nur auf Grundlage der
      ...
      <p>
        ...
        sich bei uns (max@mustermann.at) oder der Datenschutzbehörde zu
        beschweren.
      </p>
      <h5>Sie erreichen uns unter folgenden Kontaktdaten:</h5>{" "}
      <p>
        <b>Webseitenbetreiber:</b> Lorenz Windisch
        <br /> <b>Telefonnummer:</b> 01546564564
        <br /> <b>Email:</b> max@mustermann.at
      </p>
      <p>
        Quelle:{" "}
        <b>
